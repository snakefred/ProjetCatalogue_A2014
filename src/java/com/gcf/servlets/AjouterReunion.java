...
public class AjouterReunion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String typeMessage;
         ...
         int idCatalogue= Integer.parseInt(request.getParameter("idCat"));
        ...
        if ((perm==null)||((perm.getValeurPermission()&Operation.creerReunion)!=Operation.creerReunion)){
              message="Vous  ne possedez pas le droit de création de réunions dans ce catalogue.";
         ...
         if (titre==""){
            ...
            typeMessage="msg error";
             ...
             Reunion reu = new Reunion(dateComplete,titre,idCreateur,null,idCatalogue);
             if (rDAO.create(reu)){
