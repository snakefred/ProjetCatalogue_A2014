...
public class ChercherListeDossiersReunions extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("listeDossiers",(new DossierDAO(Connexion.getInstance())).findAll("idCatalogue", String.valueOf(idCatalogue))); 
        //Liste des réunions liées au catalogue.
        request.setAttribute("listeReunions",(new ReunionDAO(Connexion.getInstance())).findAll("idCatalogue", String.valueOf(idCatalogue)));
